...
namespace Домашнее_задание__4.ViewModels
{
    public class MainViewModel : ViewModelBase
    {
        private ObservableCollection<IExplorer> _items = new ObservableCollection<IExplorer>(new IExplorer[] {new Домашнее_задание__4.Class.File("asd", "asd")});

        public ObservableCollection<IExplorer> Items => _items;

        // public ObservableCollection<IExplorer> Items
        // {
        //     set => _items = value;
        // }
