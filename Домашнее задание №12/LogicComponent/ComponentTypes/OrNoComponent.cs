...
public class OrNoComponent : BaseComponent
{
    public override string Name { get; } = "ИЛИ-НЕ";
    ...
    {
        var asset = new Bitmap(AssetLoader.Open(new Uri("avares://hw_12/Assets/or_no_gost.png")));
    ...
    {
        var asset = new Bitmap(AssetLoader.Open(new Uri("avares://hw_12/Assets/or_no_ansi.png")));
