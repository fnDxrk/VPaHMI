...
public class XorComponent : BaseComponent
{
    ...
    {
        var asset = new Bitmap(AssetLoader.Open(new Uri("avares://hw_12/Assets/xor_gost.png")));
    ...
    {
        var asset = new Bitmap(AssetLoader.Open(new Uri("avares://hw_12/Assets/xor_ansi.png")));
